...
![REST API](https://img.shields.io/badge/REST-009688?logo=fastapi&logoColor=white)
...
- 📱 **Mobile Apps**: Desarrollo aplicaciones nativas multiplataforma con Flutter y React Native
- 🌐 **Web Development**: Creo sitios web responsivos y modernos con HTML/CSS/JS
- ⚙️ **Backend**: Construyo APIs robustas y eficientes con Python y Java
- 🗄️ **Databases**: Diseño y gestiono bases de datos SQL optimizadas
...
- 🎓 Completando Bootcamp Full Stack Development
- 💼 Buscando oportunidades como **Full Stack Developer** / **Backend Developer**
- 📚 Profundizando en arquitecturas de microservicios y testing

---

## 📫 Conectemos

[![LinkedIn](https://img.shields.io/badge/-LinkedIn-0077B5?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/alberto-madrid-redondo)
[![Email](https://img.shields.io/badge/-Email-D14836?style=flat-square&logo=gmail&logoColor=white)](mailto:albertomadrid93@gmail.com)

---

⭐️ *"El código limpio siempre parece que fue escrito por alguien a quien le importa"* - Robert C. Martin

![Profile Views](https://komarev.com/ghpvc/?username=Alberedo&color=blueviolet&style=flat-square)
